...
public class EmployeeController {
    ...
    public ResponseEntity<String> deleteEmployee(@PathVariable Long userId) throws IOException {
...
// 1. Bulk Employees ganna endpoint eka (Auth service eken call karanne)
    ...
    // 2. Image eka Frontend ekata pennana endpoint eka (Oya kalin dunnu monolithic code eken gaththa eka)
