...
public class AppointmentController {
    ...
    public ResponseEntity<?> bookAppointment(
        ...
        if (!canManage(role)) return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Access Denied");
    ...
    public ResponseEntity<?> updateStatus(
        ...
        if (!canView(role)) return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Access Denied");
